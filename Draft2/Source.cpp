...
int main() {
    ...
    while (!userTimeFlag) {
        ...
        if (userTime.length() == 2) {
            if (userTime[0] < 49 || userTime[0] > 50) {
                userTimeFlag = false;
                cout << "Wrong option! Please choose again: ";
                getline(cin, userTime);
            }
            else if (userTime[0] == 49) {
                if (userTime[1] < 48 || userTime[1] > 57) {
                    userTimeFlag = false;
                    cout << "Wrong option! Please choose again: ";
                    getline(cin, userTime);
                }
            }
            else if (userTime[0] == 50) {
                if (userTime[1] < 48 || userTime[1] > 52) {
                    userTimeFlag = false;
                    cout << "Wrong option! Please choose again: ";
                    getline(cin, userTime);
                }
        ...
        if (userTime.length() == 1) {
            if (userTime[0] < 49 || userTime[0] > 57) {
                userTimeFlag = false;
                cout << "Wrong option! Please choose again: ";
                getline(cin, userTime);
            }
